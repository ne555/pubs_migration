...
insert into sales values('7131', 'N914008', '94/09/14', 20, 'Net 30','PS2091');
insert into sales values('7131', 'N914014', '94/09/14', 25, 'Net 30','MC3021');
insert into sales values('8042', '423LL922', '94/09/14', 15, 'ON invoice','MC3021');
insert into sales values('8042', '423LL930', '94/09/14', 10, 'ON invoice','BU1032');
insert into sales values('6380', '722a', '94/09/13', 3, 'Net 60','PS2091');
insert into sales values('6380', '6871', '94/09/14', 5, 'Net 60','BU1032');
insert into sales values('8042','P723', '93/03/11', 25, 'Net 30', 'BU1111');
insert into sales values('7896','X999', '93/02/21', 35, 'ON invoice', 'BU2075');
insert into sales values('7896','QQ2299', '93/10/28', 15, 'Net 60', 'BU7832');
insert into sales values('7896','TQ456', '93/12/12', 10, 'Net 60', 'MC2222');
insert into sales values('8042','QA879.1', '93/5/22', 30, 'Net 30', 'PC1035');
insert into sales values('7066','A2976', '93/5/24', 50, 'Net 30', 'PC8888');
insert into sales values('7131','P3087a', '93/5/29', 20, 'Net 60', 'PS1372');
insert into sales values('7131','P3087a', '93/5/29', 25, 'Net 60', 'PS2106');
insert into sales values('7131','P3087a', '93/5/29', 15, 'Net 60', 'PS3333');
insert into sales values('7131','P3087a', '93/5/29', 25, 'Net 60', 'PS7777');
insert into sales values('7067','P2121', '92/6/15', 40, 'Net 30', 'TC3218');
insert into sales values('7067','P2121', '92/6/15', 20, 'Net 30', 'TC4203');
insert into sales values('7067','P2121', '92/6/15', 20, 'Net 30', 'TC7777');
...
insert into employee values ('PTC11962M', 'Philip', 'T', 'Cramer', 2, 215, '9952', '89/11/11');
insert into employee values ('AMD15433F', 'Ann', 'M', 'Devon', 3, 200, '9952', '91/07/16');
insert into employee values ('F-C16315M', 'Francisco', '', 'Chang', 4, 227, '9952', '90/11/03');
insert into employee values ('LAL21447M', 'Laurence', 'A', 'Lebihan', 5, 175, '0736', '90/06/03');
insert into employee values ('PXH22250M', 'Paul', 'X', 'Henriot', 5, 159, '0877', '93/08/19');
insert into employee values ('SKO22412M', 'Sven', 'K', 'Ottlieb', 5, 150, '1389', '91/04/05');
insert into employee values ('RBM23061F', 'Rita', 'B', 'Muller', 5, 198, '1622', '93/10/09');
insert into employee values ('MJP25939M', 'Maria', 'J', 'Pontes', 5, 246, '1756', '89/03/01');
insert into employee values ('JYL26161F', 'Janine', 'Y', 'Labrune', 5, 172, '9901', '91/05/26');
insert into employee values ('CFH28514M', 'Carlos', 'F', 'Hernadez', 5, 211, '9999', '89/04/21');
insert into employee values ('VPA30890F', 'Victoria', 'P', 'Ashworth', 6, 140, '0877', '90/09/13');
insert into employee values ('L-B31947F', 'Lesley', '', 'Brown', 7, 120, '0877', '91/02/13');
insert into employee values ('ARD36773F', 'Anabela', 'R', 'Domingues', 8, 100, '0877', '93/01/27');
insert into employee values ('M-R38834F', 'Martine', '', 'Rance', 9, 75, '0877', '92/02/05');
insert into employee values ('PHF38899M', 'Peter', 'H', 'Franken', 10, 75, '0877', '92/05/17');
insert into employee values ('DBT39435M', 'Daniel', 'B', 'Tonini', 11, 75, '0877', '90/01/01');
insert into employee values ('H-B39728F', 'Helen', '', 'Bennett', 12, 35, '0877', '89/09/21');
insert into employee values ('PMA42628M', 'Paolo', 'M', 'Accorti', 13, 35, '0877', '92/08/27');
insert into employee values ('ENL44273F', 'Elizabeth', 'N', 'Lincoln', 14, 35, '0877', '90/07/24');

insert into employee values ('MGK44605M', 'Matti', 'G', 'Karttunen', 6, 220, '0736', '94/05/01');
insert into employee values ('PDI47470M', 'Palle', 'D', 'Ibsen', 7, 195, '0736', '93/05/09');
insert into employee values ('MMS49649F', 'Mary', 'M', 'Saveley', 8, 175, '0736', '93/06/29');
insert into employee values ('GHT50241M', 'Gary', 'H', 'Thomas', 9, 170, '0736', '88/08/09');
insert into employee values ('MFS52347M', 'Martin', 'F', 'Sommer', 10, 165, '0736', '90/04/13');
insert into employee values ('R-M53550M', 'Roland', '', 'Mendel', 11, 150, '0736', '91/09/05');
insert into employee values ('HAS54740M', 'Howard', 'A', 'Snyder', 12, 100, '0736', '88/11/19');
insert into employee values ('TPO55093M', 'Timothy', 'P', 'O''Rourke', 13, 100, '0736', '88/06/19');
insert into employee values ('KFJ64308F', 'Karin', 'F', 'Josephs', 14, 100, '0736', '92/10/17');
insert into employee values ('DWR65030M', 'Diego', 'W', 'Roel', 6, 192, '1389', '91/12/16');
insert into employee values ('M-L67958F', 'Maria', '', 'Larsson', 7, 135, '1389', '92/03/27');
insert into employee values ('PSP68661F', 'Paula', 'S', 'Parente', 8, 125, '1389', '94/01/19');
insert into employee values ('MAS70474F', 'Margaret', 'A', 'Smith', 9, 78, '1389', '88/09/29');
insert into employee values ('A-C71970F', 'Aria', '', 'Cruz', 10, 87, '1389', '91/10/26');
insert into employee values ('MAP77183M', 'Miguel', 'A', 'Paolino', 11, 112, '1389', '92/12/07');
insert into employee values ('Y-L77953M', 'Yoshi', '', 'Latimer', 12, 32, '1389', '89/06/11');
insert into employee values ('CGS88322F', 'Carine', 'G', 'Schmitt', 13, 64, '1389', '92/07/07');
insert into employee values ('PSA89086M', 'Pedro', 'S', 'Afonso', 14, 89, '1389', '90/12/24');
insert into employee values ('A-R89858F', 'Annette', '', 'Roulet', 6, 152, '9999', '90/02/21');
insert into employee values ('HAN90777M', 'Helvetius', 'A', 'Nagy', 7, 120, '9999', '93/03/19');
insert into employee values ('M-P91209M', 'Manuel', '', 'Pereira', 8, 101, '9999', '89/01/09');
insert into employee values ('KJJ92907F', 'Karla', 'J', 'Jablonski', 9, 170, '9999', '94/03/11');
insert into employee values ('POK93028M', 'Pirkko', 'O', 'Koskitalo', 10, 80, '9999', '93/11/29');
insert into employee values ('PCM98509F', 'Patricia', 'C', 'McKenna', 11, 150, '9999', '89/08/01');

CREATE  INDEX employee_ind ON employee(lname, fname, minit);
CREATE  INDEX aunmind ON authors (au_lname, au_fname);
CREATE  INDEX s_titleidind ON sales (title_id);
CREATE  INDEX titleind ON titles (title);
CREATE  INDEX auidind ON titleauthor (au_id);
CREATE  INDEX ta_titleidind ON titleauthor (title_id);
CREATE  INDEX ro_titleidind ON roysched (title_id);
